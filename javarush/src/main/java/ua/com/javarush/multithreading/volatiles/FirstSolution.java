package ua.com.javarush.multithreading.volatiles;
...
public class FirstSolution extends Thread {
    ...
    private static final Logger log = Logger.getLogger(FirstSolution.class.getName());
    ...
    public FirstSolution(String name) {
