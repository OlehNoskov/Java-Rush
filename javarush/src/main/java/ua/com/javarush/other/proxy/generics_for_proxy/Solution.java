package ua.com.javarush.other.proxy.generics_for_proxy;
...
public class Solution {
    public static void main(String[] args) {
        ...
        test(solution.getProxy(Item.class, Small.class));           //true false false
        test(solution.getProxy(Item.class, Small.class));           //true false true
        test(solution.getProxy(Item.class, Big.class, Small.class));//true true true
        test(solution.getProxy(Big.class, Small.class));            //true true true т.к. Big наследуется от Item
        test(solution.getProxy(Big.class, Small.class));            //true true false т.к. Big наследуется от Item
    }
