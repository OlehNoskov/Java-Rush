...
public class SecondTaskAutoBoxing {
    ...
    private Logger logger = Logger.getLogger(SecondTaskAutoBoxing.class.getName());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SecondTaskAutoBoxing solution = new SecondTaskAutoBoxing();
